                ...
                <div class="card-small">
                    ...
                    <div class="card-small-info">
                        <div v-if="weatherInfo?.wind?.gust" class="card-small-data">
                            <div class="info-main-num">
                                {{ Math.floor(weatherInfo?.wind?.gust)}}
                            </div>
                            <div class="info-main-text">
                                m/s
                            </div>
            ...
            <div class="highlight">
                <div class="card">
                    ...
                    <div class="card-info">
                        <div class="card-centered">
                            <div class="info-main">
                                <div class="info-main-num">
                                {{ Math.floor(weatherInfo?.main?.pressure/1.333) || 0 }}
                                </div>
                                <div class="info-main-text">
                                mm
                                </div>
                ...
                <div class="card-small">
                    ...
                    <div class="card-small-info">
                        ...
                        <div class="info-main-num">
                            {{ Math.floor(weatherInfo?.main?.feels_like) || 0 }}
                        </div>
                        <div class="info-main-text">
                            °C
                        </div>
